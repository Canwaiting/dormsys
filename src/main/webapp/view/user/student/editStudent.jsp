...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-5 col-md-offset-2 main" >
      <form class="form-horizontal" method="post" action="/editStu">
        ...
        <div class="form-group form-group-lg">
          <label class="col-sm-2 control-label" >对应学生的学号:</label>
          <div class="col-sm-10">
            <input class="form-control" type="text"  name="stu_id" placeholder="对应学生的学号">
          </div>
        </div>
        <%--学号--%>
